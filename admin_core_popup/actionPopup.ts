...
export class ActionPopup{
    ...
    async showAlertPop(){
        ...
        await this.actionSupport.presentElement(this.alert_popup)
    }

    async showInfoPop(){
        console.log ("Show the INFORMATION popup")
        await this.actionSupport.presentElement(this.info_popup)
    }

    async showAttentionPop(){
        console.log ("Show the ATTENTION popup")
        await this.actionSupport.presentElement(this.attention_popup)
    }

    async showCopyPop(){
        console.log("Show the COPY popup")
        await this.actionSupport.presentElement(this.copy_popup)
    }
