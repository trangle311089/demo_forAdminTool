...
export class Tier1HorizontalMenu{
    ...
    async showUsersMenu(){
        console.log ("Check the Tier 1 horizontal Users menu is displayed")
    ...
    async showTeamsMenu(){
        console.log ("Check the Tier 1 horizontal Teams menu is displayed")
    ...
    async showGroupsMenu(){
        console.log ("Check the Tier 1 horizontal Groups menu is displayed")
